package com.example.finalproject.debitCard.business.concretes;
...
import com.example.finalproject.creditCard.rules.CardRules;
...
public class DebitCardManager implements DebitCardService {
    ...
    @Override
    @Transactional
    public ServiceResponse add(long customerId, CreateDebitCardRequest createDebitCardRequest) throws NotFoundCheckingAccountException, AccountAlreadyHasADebitCardException, CustomerNotFoundException, NotAccountOwnerException, AccountAlreadyHasADebitCardException {
